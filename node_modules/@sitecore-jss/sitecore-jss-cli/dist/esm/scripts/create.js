...
const getDeprecationMessage = (argv = {}) => [
    ...
    chalk.green(`npx create-sitecore-jss ${(argv === null || argv === void 0 ? void 0 : argv.template) || 'nextjs'}`),
    ...
    chalk.green(`jss create ${(argv === null || argv === void 0 ? void 0 : argv.name) || 'nextjs-app'} ${(argv === null || argv === void 0 ? void 0 : argv.template) ||
