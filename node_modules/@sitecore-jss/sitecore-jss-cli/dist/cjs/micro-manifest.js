    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        return new Promise((resolve, reject) => {
            tmp_1.default.dir({ unsafeCleanup: true }, (err, tempDir, cleanupTempDir) => __awaiter(this, void 0, void 0, function* () {
                ...
                yield (0, manifest_1.handler)(manifestArgs);
                ...
                yield (0, package_1.handler)(packageArgs);
                const deployArgs = {
                ...
                yield (0, sitecore_jss_dev_tools_1.packageDeploy)(deployArgs);
                cleanupTempDir();
                resolve();
            }));
        });
...
function verifyArgs(argv) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const jssConfig = yield (0, sitecore_jss_dev_tools_1.resolveScJssConfig)({ configPath: argv.config });
        if (!argv.deployUrl) {
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
