...
function handler(argv) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if ((0, fs_1.existsSync)(argv.manifestOutputPath)) {
            (0, sitecore_jss_dev_tools_1.clean)({ path: argv.manifestOutputPath });
        }
        const assetsPath = path_1.default.join(argv.manifestOutputPath, 'assets');
        if ((0, fs_1.existsSync)(assetsPath)) {
            (0, sitecore_jss_dev_tools_1.clean)({ path: assetsPath });
        }
        return (0, sitecore_jss_dev_tools_1.generateToFile)(generateArgs).catch((err) => {
