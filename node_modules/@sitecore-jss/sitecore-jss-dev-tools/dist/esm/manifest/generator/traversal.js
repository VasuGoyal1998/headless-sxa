...
export const traverseItems = (items, callback) => {
    if (!items) {
        return;
    }
    const traverseInternal = (itemArray, paths) => {
 ...
 */
export function traverseAllItems(items, callback) {
    ...
    function processSingleItem(item, type) {
        ...
        if (item.fields) {
            Object.keys(item.fields).forEach((fieldName) => {
                ...
                const processCandidateFieldValue = (value) => {
 ...
 * @param {Function} callback
 */
export function traverseAllFields(items, callback) {
 ...
 * @param {Function} callback
 */
export function traverseAllRenderings(items, callback) {
