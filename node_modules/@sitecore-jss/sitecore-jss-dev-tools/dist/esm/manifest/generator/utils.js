...
const mapFieldValueItem = (item, fieldValueItem, index, fieldName) => {
    ...
    fieldItem.fields = convertComponentDataToFields({
 ...
 */
export function checkUnique(input, selector) {
 ...
 */
export function findComponent(componentName, components) {
    if (!components) {
        return undefined;
    }
 ...
 * @returns {ComponentDefinition | undefined} component
 */
export function findComponentForTemplate(templateName, components) {
    var _a;
    if (!components) {
        return undefined;
    }
 ...
 */
export function findTemplate(templateName, templates) {
    if (!templates) {
        return undefined;
    }
 ...
 * @returns {TemplateDefinition | undefined} template
 */
export function findTemplateForComponent(component, templates) {
...
export function validateFieldDefinitions(fields, template, handleError, ...inheritedTemplates) {
    ...
    return filterObject(fields, (fieldName) => {
