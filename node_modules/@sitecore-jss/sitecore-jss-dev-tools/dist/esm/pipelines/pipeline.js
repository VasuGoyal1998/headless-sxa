...
const enhanceProcessors = (processors) => processors.map((processor) => {
    if (processor.modulePath) {
        ...
        return Object.assign(Object.assign({}, processor), { moduleWrapper: importModules(importArgs)[0] });
    }
    return processor;
});
 ...
 */
export const run = (pipeline) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const pipelineResult = yield runProcessors({
 ...
 */
export const runWithCompilers = (compilers) => (pipeline) => __awaiter(void 0, void 0, void 0, function* () {
    yield initCompilers(compilers);
    return run(pipeline);
});
