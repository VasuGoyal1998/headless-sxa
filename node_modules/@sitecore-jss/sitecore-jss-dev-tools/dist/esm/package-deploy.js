 ...
 */
export function applyCertPinning(req, options) {
 ...
 * @param {string} fp2
 */
export function doFingerprintsMatch(fp1, fp2) {
 ...
 */
export function finishWatchJobStatusTask({ warnings, errors, resolve, reject, }) {
    console.log();
 ...
 * @param {string[]} params.errors
 */
export function logJobStatus({ message, entryLevel, warnings, errors, }) {
    switch (entryLevel) {
        case 'WARN':
 ...
 * @param {PackageDeployOptions} options
 */
export function packageDeploy(options) {
    return __awaiter(this, void 0, void 0, function* () {
        if (!options.secret) {
        ...
        const factors = [options.appName, options.importServiceUrl, yield digest(packageFile)];
        if (options.debugSecurity) {
