...
class ManifestManager {
    ...
    setManifestUpdatedCallback(callback) {
        ...
        this.watcher = (0, chokidar_1.watch)(this.watcherSourcePaths, {
            ignoreInitial: true,
            ...
            try {
                callback(yield (0, generate_1.generateToVariable)(this.manifestArgs));
            }
            catch (e) {
                console.error(e);
            }
    ...
    getManifestPath() {
        return (0, path_1.join)(this.rootPath, (0, path_1.dirname)(this.manifestArgs.outputPath));
    }
    getManifest(language) {
        ...
        if (this.initialManifest) {
            ...
            return (0, generate_1.generateToFile)(this.manifestArgs);
        }
        // subsequent manifestings can be to memory, as the content is only being redone
        return (0, generate_1.generateToVariable)(this.manifestArgs);
    }
}
