...
const createManifestInstance = ({ pipelines, appName = '', excludeItems = false, excludeDictionary = false, language = '', debug = false, wipe = false, rootPlaceholders, skipPlaceholderBlacklist, }) => {
    ...
    const addTemplateInternal = (...templates) => {
        templates.forEach((template) => {
            const validationResult = (0, validators_1.validateTemplate)(template);
    ...
    const addPlaceholder = (...placeholders) => {
        placeholders.forEach((placeholder) => {
            if ((0, validators_1.validatePlaceholder)(placeholder).valid) {
    ...
    const getManifest = () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const result = yield (0, pipelines_1.runPipeline)(pipeline);
...
exports.createManifestInstance = createManifestInstance;
