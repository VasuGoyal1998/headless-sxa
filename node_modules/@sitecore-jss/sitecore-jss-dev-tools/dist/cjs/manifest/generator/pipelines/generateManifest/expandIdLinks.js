...
exports.default = (args) => {
    ...
    const handleField = (field) => {
        if (field.value && field.value.href && field.value.href.startsWith('jss://')) {
            ...
            let path = '';
            (0, traversal_1.traverseItems)(manifest.items.routes, (item, currentPath) => {
    ...
    (0, traversal_1.traverseAllFields)(manifest.items.routes, handleField);
    (0, traversal_1.traverseAllFields)(manifest.items.nonRoutes, handleField);
    return args;
};
