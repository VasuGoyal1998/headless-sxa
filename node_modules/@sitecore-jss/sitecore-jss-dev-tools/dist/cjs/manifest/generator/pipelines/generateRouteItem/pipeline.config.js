...
const dynamicPlaceholders_1 = require("../../dynamicPlaceholders");
const processRenderings_1 = __importDefault(require("./processRenderings"));
...
const defaultDatasourceNamer = ({ item, placeholder, rendering, index, }) => {
...
const defaultDatasourceDisplayNamer = ({ rendering, index, }) => `${rendering.componentName}-${index + 1}`;
const config = (pipelines) => {
    const pipeline = index_1.pipelineFactory.create('generateRouteItem');
