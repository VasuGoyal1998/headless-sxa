...
exports.default = (args) => {
    ...
    if (componentName) {
        const component = (0, utils_1.findComponent)(componentName, args.components);
        item.template = (component === null || component === void 0 ? void 0 : component.templateName) || componentName;
    }
    const template = (0, utils_1.findTemplate)(item.template, args.templates);
    ...
    if (args.content.fields) {
        ...
        if (template) {
            ...
            renderingFields = (0, utils_1.validateFieldDefinitions)(args.content.fields, template, handleError, args.templates, args.components);
        }
        item.fields = (0, utils_1.convertComponentDataToFields)({ data: renderingFields, context: { item } });
    }
