...
exports.default = (args) => {
    ...
    const duplicateIds = (0, utils_1.checkUnique)(finalTemplates, (template) => template.id);
    if (duplicateIds.length > 0) {
        throw `The manifest defined duplicate template IDs: ${duplicateIds.join(',')}. This is not allowed.`;
    }
    const duplicateNames = (0, utils_1.checkUnique)(finalTemplates, (template) => template.name);
