...
const generateRenderings = ({ components, templates }) => components.map((component) => {
    ...
    const template = (0, utils_1.findTemplateForComponent)(component, templates);
...
exports.default = (args) => {
    ...
    const duplicateIds = (0, utils_1.checkUnique)(finalRenderings, (rendering) => rendering.id);
    if (duplicateIds.length > 0) {
        throw `The manifest defined duplicate rendering IDs: ${duplicateIds.join(',')}. This is not allowed.`;
    }
    const duplicateNames = (0, utils_1.checkUnique)(finalRenderings, (rendering) => rendering.name);
