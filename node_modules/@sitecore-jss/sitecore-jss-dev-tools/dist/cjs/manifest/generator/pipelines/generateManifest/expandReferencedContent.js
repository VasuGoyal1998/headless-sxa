...
const createIdMapping_1 = require("../../createIdMapping");
 ...
 */
function expandReferencedContent(manifest, components) {
    // because of transitive references we may need to make multiple expand passes
    let expandedItems = false;
    const idMap = (0, createIdMapping_1.createIdMapping)(manifest);
    ...
    idMap.usages.reverse().forEach((idReference) => {
        ...
        (0, traversal_1.traverseAllItems)(refDeepClone.children, (item) => {
            delete item.id;
        });
        if (targetType === 'rendering') {
            ...
            if (expandedRef.template) {
                const component = (0, utils_1.findComponentForTemplate)(expandedRef.template, components);
                expandedRef.renderingName = (component === null || component === void 0 ? void 0 : component.name) || expandedRef.template;
