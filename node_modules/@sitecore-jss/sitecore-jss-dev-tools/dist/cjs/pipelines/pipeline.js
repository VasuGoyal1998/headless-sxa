...
const enhanceProcessors = (processors) => processors.map((processor) => {
    if (processor.modulePath) {
        ...
        return Object.assign(Object.assign({}, processor), { moduleWrapper: (0, utils_1.importModules)(importArgs)[0] });
    }
    return processor;
});
...
const run = (pipeline) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const pipelineResult = yield (0, exports.runProcessors)({
...
const runWithCompilers = (compilers) => (pipeline) => __awaiter(void 0, void 0, void 0, function* () {
    yield (0, utils_1.initCompilers)(compilers);
    return (0, exports.run)(pipeline);
});
