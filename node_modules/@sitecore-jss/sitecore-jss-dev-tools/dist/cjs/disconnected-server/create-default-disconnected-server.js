...
function createDefaultDisconnectedServer(options) {
    ...
    if (options.appRoot.endsWith('scripts')) {
        options.appRoot = (0, path_1.join)(options.appRoot, '..');
    }
    ...
    return manifestManager
        ...
        const layoutService = (0, layout_service_1.createDisconnectedLayoutService)({
            manifest,
        ...
        const dictionaryService = (0, dictionary_service_1.createDisconnectedDictionaryService)({
            manifest,
            manifestLanguageChangeCallback: manifestManager.getManifest,
        });
        ...
        app.use('/assets', express_1.default.static((0, path_1.join)(options.appRoot, 'assets')));
        app.use('/data/media', express_1.default.static((0, path_1.join)(options.appRoot, 'data/media')));
