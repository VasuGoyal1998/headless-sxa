export declare const traverseItems: (items: any[], callback: (item: any, currentPath: string) => any) => void;
/**
 ...
 * @param {Function} callback
 */
export declare function traverseAllRenderings(items: any, callback: (rendering: any, item: any) => any): void;
