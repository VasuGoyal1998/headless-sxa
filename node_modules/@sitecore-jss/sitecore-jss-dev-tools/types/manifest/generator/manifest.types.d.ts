...
export declare enum CommonFieldTypes {
...
export declare enum FieldStorage {
    Versioned = "versioned",
    Shared = "shared",
 ...
 */
export declare function isItemDefinition(obj: ItemDefinition | ItemReference): obj is ItemDefinition;
...
export interface GeneratePipelineArgs {
    ...
    pipelineResult: ManifestInstance & {
        [key: string]: any;
    };
}
